...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/init/fstab.mt6878:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.mt6878 \
    $(LOCAL_PATH)/init/fstab.mt6878:$(TARGET_COPY_OUT_VENDOR_RAMDISK)/first_stage_ramdisk/system/etc/fstab.mt6878
